...
Maintained by @iron_voldy ❤
"""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/hagridbot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(text="ʟᴏɢꜱ", url=f"https://t.me/hagridlogs"),
        InlineKeyboardButton(
...
Powered by :- @iron_vody """

layla_IMG = "https://telegra.ph/file/db3f8a243374a49fd40f9.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project [Hero](t.me/iron_voldy) \
 Supporting isnt always financial! [AwesomeSupport](t.me/EpicArena) \
...
def layla_about_callback(update, context):
    ...
    if query.data == "layla_":
        query.message.edit_text(
            text=""" ℹ️ I'm *HAGRID*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n❍ owner @iron_voldy.
                 \n\nIf you have any question about Hagrid, let us know at .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *HAGRID*
                 \nHere is the [Source Code](https://telegra.ph/file/e8f1a992e19a352555b7d.jpg) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
